...
if (!isset($_SESSION['admin_email'])) {
    ...
    if (isset($_GET['edit_product'])) {
        ...
        $cur_p_chatlieu = $get_p['CHAT_LIEU'];
    }
...
?>
                    ...
                    <form action="" class="form-horizontal" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="product_material" class="form-control" required value="<?php echo $cur_p_chatlieu ?>">
                                </div>
                            </div>
                        </div>
    ...
    if (isset($_POST['update'])) {
        ...
        $update_product = "update SP set 
            MA_SP='$p_id',
            TEN_SP='$p_name',
            MA_LOAISP='$p_cat',
            MA_HANGSX='$p_man',
            MIEUTA_SP='$p_about',
            CHAT_LIEU='$p_material',
            HINHANH_SP='$p_image',
            GIA='$p_price'
            where MA_SP='$cur_p_id'";
