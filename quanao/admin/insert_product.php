...
?>
            ...
            <div class="card text-dark mb-4">
                ...
                <div class="card-body">
                    <form action="" class="form-horizontal" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <label class="control-label col-sm-3 text-right mt-2">Chất Liệu:</label>
                                <div class="col-sm-6">
                                    <input type="text" name="product_material" class="form-control" required>
                                </div>
                            </div>
                        </div>
    ...
    if (isset($_POST['submit'])) {
        ...
        $p_material = $_POST['product_material'];
        ...
        $insert_product = "insert into SP 
            (MA_SP,TEN_SP,MA_LOAISP,MA_HANGSX,MIEUTA_SP,CHAT_LIEU,HINHANH_SP,GIA) 
            values 
            ('$p_id','$p_name','$p_cat','$p_man','$p_about','$p_material','$p_image','$p_price')";
