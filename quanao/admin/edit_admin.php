    ...
    <div class="col-lg-12">
        <div class="card text-dark mb-4">
            <div class="card-header">
                <h6 class="m-0 font-weight-bold"><i class="fas fa-user-edit"></i> Sửa Thông Quản Trị Viên</h6>
            </div>
            <div class="card-body">
...
<?php 
    if(isset($_POST['update'])) {
        ...
        $update_admin = "update admin set ID='$admin_id', Name='$admin_name', Email='$admin_email',Passwd='$admin_pass',Image='$admin_image',Address='$admin_address',Position='$admin_pos',About='$admin_about' where ID='$cur_id'";
