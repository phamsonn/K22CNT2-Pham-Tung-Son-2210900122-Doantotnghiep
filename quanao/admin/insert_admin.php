...
?>
    ...
    if (isset($_POST['submit'])) {
        ...
        $insertQry = "insert into `admin` (`ID`, `Name`, `Email`, `Passwd`, `Image`, `Address`, `Position`, `About`) VALUES ('$admin_id', '$admin_name', '$admin_email', '$admin_pass', '$admin_image',  '$admin_address', '$admin_pos', '$admin_about');";
