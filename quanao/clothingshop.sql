...
--
-- Host: 127.0.0.1:3307
-- Generation Time: May 07, 2026 at 11:04 AM
...
(1777304106, 'ao03', 1, 350000),
(1778144352, 'ao03', 1, 350000),
(1778144461, 'ao04', 1, 340000),
(1778144561, 'ao03', 1, 350000);
...
INSERT INTO `hoadon` (`MA_HD`, `MA_KH`, `TONGTIEN`, `TRANGTHAI`, `admin_id`, `phuong_thuc`, `GIAM_GIA`) VALUES
(1504270957, 15, 350000, 'Chưa Thanh Toán', 'ad01', 'COD', 0),
(1512051207, 15, 2500000, 'Chưa Thanh Toán', 'ad01', 'COD', 0),
(1612051219, 16, 2500000, 'Chưa Thanh Toán', 'ad01', 'COD', 0),
(1612051338, 16, 320000, 'Chưa Thanh Toán', 'ad01', 'COD', 0),
(1702270413, 17, 1020000, 'Chưa Thanh Toán', 'ad01', 'COD', 0),
(1702270605, 17, 1920000, 'Chưa Thanh Toán', 'ad01', 'COD', 0),
(1702270658, 17, 960000, 'Chưa Thanh Toán', 'ad01', 'COD', 0),
(1708191713, 17, 320000, 'Chưa Thanh Toán', 'ad01', 'COD', 0),
(1777277722, 15, 350000, 'Đã Thanh Toán', NULL, 'VNPay', 0),
(1777277826, 15, 350000, 'Đã Thanh Toán', NULL, 'VNPay', 0),
(1777280083, 15, 350000, 'Đã Thanh Toán', NULL, 'VNPay', 0),
(1777304106, 15, 350000, 'Đã Thanh Toán', NULL, 'VNPay', 0),
(1778144352, 15, 350000, 'Đã Thanh Toán', NULL, 'VNPay', 0),
(1778144461, 15, 340000, 'Đã Thanh Toán', NULL, 'VNPay', 6800),
(1778144561, 15, 350000, 'Đã Thanh Toán', NULL, 'VNPay', 7000);
...
INSERT INTO `sp` (`MA_SP`, `TEN_SP`, `MA_LOAISP`, `MA_HANGSX`, `MIEUTA_SP`, `HINHANH_SP`, `GIA`, `CHAT_LIEU`) VALUES
('ao01', 'TEE SNOW BEAR', 'L002', 'H001', 'Chất liệu vải cotton thoáng khí', 'ao01.jpg', 320000, 'Cotton'),
('ao03', 'MELTING CHEESE', 'L002', 'H001', 'Chất liệu vải cotton thoáng khí', 'ao03.jpg', 350000, 'Cotton'),
('ao04', 'SPACE TEE MST', 'L002', 'H001', 'Chất liệu vải cotton thoáng khí', 'ao04.jpg', 340000, 'Cotton'),
('ao05', 'CARDIGAN LOGO M', 'L002', 'H001', 'Chất liệu vải cotton thoáng khí', 'ao05.jpg', 420000, 'Cotton'),
('ao06', 'SÆ  MI LOGO ( SHIRT )', 'L002', 'H001', 'Chất liệu vải cotton thoáng khí', 'ao06.png', 380000, 'Cotton'),
('ao07', 'LOGO LINE TEE', 'L002', 'H001', 'Chất liệu vải cotton thoáng khí', 'ao07.jpg', 320000, 'Cotton'),
('giay01', 'MST LOGO SLIPPER', 'L001', 'H001', 'Chất liệu vải cotton thoáng khí', 'giay01.jpg', 380000, 'Cotton'),
('giay02', 'ZX 1K BOOST', 'L001', 'H002', 'Chất liệu vải cotton thoáng khí', 'giay02.jpg', 2500000, 'Cotton'),
('giay03', 'CHUCK TAYLOR ALL STAR MADISON HYBRID SHINE', 'L001', 'H004', 'Chất liệu vải cotton thoáng khí', 'giay03.jpg', 1500000, 'Cotton'),
('quan01', 'LOGO PANTS', 'L003', 'H001', 'Chất liệu vải cotton thoáng khí', 'quan01.jpg', 420000, 'Cotton'),
('quan02', 'SWEATPANTS LOGO', 'L003', 'H001', 'Chất liệu vải cotton thoáng khí', 'quan02.jpg', 380000, 'Cotton'),
('tui01', 'Wallet Logo', 'L004', 'H004', 'Chất liệu vải cotton thoáng khí', 'tui01.jpg', 250000, 'Cotton'),
('tui02', 'BACKPACK LOGO MISSOUT', 'L004', 'H001', 'Chất liệu vải Polyester thoáng khí \r\n                             \r\n                            ', 'tui02.jpg', 580000, 'Polyester'),
('tui03', 'MST SHOULDER BAG', 'L004', 'H001', 'Chất liệu vải cotton thoáng khí', 'tui03.jpg', 350000, 'Cotton');
...
--
ALTER TABLE `hoadon`
  MODIFY `MA_HD` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1778144562;
